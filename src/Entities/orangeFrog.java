...
public class orangeFrog extends Entity{

	public int jumpTimer;

	public orangeFrog(int x, int y, int w, int h, boolean visible, String path) {
		super(x, y, w, h, visible, path);
		Sprite = getImage("/imgs/Monsters/OrangeFrog/orangeFrogStand.gif");
		...
		for(Block[] blockArray : LevelBuilder.level) {
			for(Block block : blockArray) {
				...
				case 0:
					if(flag == false) {
						grounded = false;
						Sprite = getImage("/imgs/Monsters/OrangeFrog/orangeFrogJump.gif");
